...
class KMeansClass:
  def __init__(self, KMnInit, num_clusters):
    self.kMeans(KMnInit, num_clusters)

  def kMeans(self, KMnInit, num_clusters):
    ...
    kmeans = KMeans(init='k-means++', n_clusters=num_clusters, n_init=KMnInit)
    kmeans.fit(X)
